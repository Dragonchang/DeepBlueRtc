...
JNIEXPORT jlong JNICALL Java_com_deepblue_librtmp_RtmpJni_initRtmp(JNIEnv* env,jclass jcls,jstring jurl,jstring jlogpath)
{
...
JNIEXPORT jint JNICALL Java_com_deepblue_librtmp_RtmpJni_sendVideoFrame(JNIEnv* env,jclass jcls,jlong cptr,jbyteArray jframe, jint len,jint time)
{
...
JNIEXPORT jint JNICALL Java_com_deepblue_librtmp_RtmpJni_sendAacSpec(JNIEnv* env, jclass jcls,jlong cptr, jbyteArray jaacSpec, jint jlen)
{
...
JNIEXPORT jint JNICALL Java_com_deepblue_librtmp_RtmpJni_sendAacData(JNIEnv* env, jclass jcls, jlong cptr,jbyteArray jaccFrame, jint jlen, jint jtimestamp)
{
...
JNIEXPORT jint JNICALL Java_com_deepblue_librtmp_RtmpJni_stopRtmp(JNIEnv* env,jclass jcls,jlong cptr)
{
